...
| Q3 Kano walls | 0 | HOLDS (wrong) | "11 miles, 30–40 ft, 15 ft thick" vs. source "14 miles, 30–50 ft, ~40 ft at base". All three specifics wrong against the cited GT (Orr); held confidently. [Amended 2026-08-30: Shaw's in-corpus account gives the wall as eleven miles in circumference and forty feet thick at the base — so "11 miles" matches Shaw, and the thickness the baseline gave (15 ft) matches neither source. Score stands at 0 against the asked 1903-expedition GT; the amendment is recorded for fairness. The solution condition handled the same conflict by citing both sources.] |
